...
export async function get(url) {
    return requst(url, createOptions());
}

export async function post(url, data) {
    return requst(url, createOptions('post', data));
}

export async function put(url, data) {
    return requst(url, createOptions('put', data));
}

export async function del(url) {
    return requst(url, createOptions('delete'));
}
